...
export const MeiOpportunity: React.FC = () => {
  return (
    // SECTION WRAPPER
    // -mt-32: Pulls the section UP over the Hero
    // z-20: Ensures it sits ON TOP of the Hero content/wave
    // rounded-t-[3rem]: Creates the "Physical Sheet" look
    <section className="relative z-20 -mt-20 lg:-mt-32 pb-16 bg-[#F8FAFC] rounded-t-[2.5rem] lg:rounded-t-[4rem] shadow-[0_-20px_80px_-20px_rgba(0,0,0,0.3)] border-t border-white/40 overflow-hidden">
      
      {/* 
        Decorative Top Highlight 
        Adds a glossy edge to the rounded top, enhancing the 3D feel
      */}
