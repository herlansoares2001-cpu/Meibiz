...
export const ComparativeTable: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-white border-t border-slate-100 overflow-x-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-medium text-slate-900 text-center mb-12">Compare os benefícios</h2>
        
        <div className="border border-slate-200 rounded-2xl overflow-hidden min-w-[800px]">
